...
typedef void (^webUrlBlock) (NSString *url,NSInteger type);

//求助变迁的block
typedef void (^tagBlock) (NSInteger tagID);

@interface MytopicViewTableViewCell : UITableViewCell
...
//用来查看大表格
@property (strong,nonatomic) webUrlBlock webB;
