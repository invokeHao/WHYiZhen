...
-(void)createUI
{
    ...
    _selectedView.backgroundColor=themeColor;
    _selectedView.layer.cornerRadius=10;
    _selectedView.layer.masksToBounds=YES;
    _selectedView.userInteractionEnabled=YES;
    _selectedView.hidden=YES;
    UITapGestureRecognizer*tap=[[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(tapTheCellToSelect:)];
...
-(void)tapTheCellToSelect:(UITapGestureRecognizer*)tap
{
