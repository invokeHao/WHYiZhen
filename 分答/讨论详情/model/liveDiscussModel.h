...
@property (strong, nonatomic) NSString *replyCreatorName;//回复人姓名
@property (assign,nonatomic) NSInteger replyCreatorId;
@property (assign,nonatomic) BOOL sendByDoctor;//医生发的
@property (assign,nonatomic) BOOL sendByAssistant;//管理员发的
